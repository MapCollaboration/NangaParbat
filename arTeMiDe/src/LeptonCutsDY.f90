...
subroutine SetCutParameters(Q_in,y_in,pT_in,etaMin_in,etaMax_in)
  real*8::Q_in,y_in,pT_in,etaMax_in,etaMin_in
...
function CutFactor2(qT)
  real*8:: qT,CutFactor2
...
function CutFactor(qT)
  real*8::CutFactor,qT,pT,etaMax,etaMin
  real*8::Z,W,f
...
function CutFactor3(qT)
  real*8:: qT,CutFactor3
  real*8:: dphi
  integer :: i
