...
plot "Benchmark.dat" index 0 u 1:($3/$5)  w l lt 7 lw 5 lc rgb "red"  t "R_g", \
     "Benchmark.dat" index 0 u 1:($4/$6) w l lt 7 lw 5 lc rgb "blue" t "R_q", \
...
plot "Benchmark.dat" index 0 u 1:($8/$12) w l lt 7 lw 5 lc rgb "blue"       t "Singlet", \
     "Benchmark.dat" index 0 u 1:($9/$13) w l lt 7 lw 5 lc rgb "orange"     t "Total valence", \
     "Benchmark.dat" index 0 u 1:($10/$14) w l lt 7 lw 5 lc rgb "dark-green" t "T_3", \
     f(x) w l lt 4 lc rgb "black" notitle

set yrange[0.2:1.5]
plot "Benchmark.dat" index 0 u 1:($7/$11) w l lt 7 lw 5 lc rgb "red"        t "Gluon", \
     f(x) w l lt 4 lc rgb "black" notitle
...
plot "Benchmark.dat" index 0 u 1:($19/$11) w l lt 7 lw 5 lc rgb "red"  t "arTeMiDe", \
     "Benchmark.dat" index 0 u 1:($15/$7)  w l lt 7 lw 5 lc rgb "blue" t "APFEL++",\
     f(x) w l lt 4 lc rgb "black" notitle
...
set ylabel "DGauss / Ogata" font 'Times-Roman,22'
set title "Drell-Yan at {/Symbol @\326\140}s = 8 TeV, y = 2.5, Q = M_Z, narrow-width approximation, full NNLO"
set xrange[1:30]
set yrange[0.999:1.001]
set xlabel "q_T [GeV]" font 'Times-Roman,22'
plot "Benchmark.dat" index 1 u 1:($4/$2) w l lt 7 lw 5 lc rgb "red" t "APFEL++", \
     f(x) w l lt 4 lc rgb "black" notitle
